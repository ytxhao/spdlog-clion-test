...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_search_5frequest_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_search_5frequest_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_search_5frequest_2eproto = nullptr;

const uint32_t TableStruct_search_5frequest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_search_5frequest_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\024search_request.proto\"L\n\rSearchRequest\022"
  "\r\n\005query\030\001 \001(\t\022\023\n\013page_number\030\002 \001(\005\022\027\n\017r"
  "esult_per_page\030\003 \001(\005b\006proto3"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_search_5frequest_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_search_5frequest_2eproto = {
  false, false, 108, descriptor_table_protodef_search_5frequest_2eproto, "search_request.proto", 
  &descriptor_table_search_5frequest_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_search_5frequest_2eproto::offsets,
  file_level_metadata_search_5frequest_2eproto, file_level_enum_descriptors_search_5frequest_2eproto, file_level_service_descriptors_search_5frequest_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_search_5frequest_2eproto_getter() {
  return &descriptor_table_search_5frequest_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_search_5frequest_2eproto(&descriptor_table_search_5frequest_2eproto);
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          result_per_page_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(message_byte_size_start:SearchRequest)
  ...
  // int32 page_number = 2;
  if (this->_internal_page_number() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_page_number());
  }

  // int32 result_per_page = 3;
  if (this->_internal_result_per_page() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_result_per_page());
  }
...
::PROTOBUF_NAMESPACE_ID::Metadata SearchRequest::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_search_5frequest_2eproto_getter, &descriptor_table_search_5frequest_2eproto_once,
      file_level_metadata_search_5frequest_2eproto[0]);
}
